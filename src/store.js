  ...
  function(e, n) {
      ...
      if (! (k || w || C.debug || x < '6.0.2' || V.systemType < 0)) {
        ...
        N.getNetworkType({
          ...
          success: function(e) {
            ...
            let i = 'https://open.weixin.qq.com/sdk/report?v=' + V.version + '&o=' + V.isPreVerifyOk + '&s=' + V.systemType + '&c=' + V.clientVersion + '&a=' + V.appId + '&n=' + V.networkType + '&i=' + V.initTime + '&p=' + V.preVerifyTime + '&u=' + V.url;
            n.src = i;
          }
        });
      }
    ...
    if (!e.jWeixin) {
      var h = {
        ...
        x = function() {
          let e = y.match(/micromessenger\/(\d+\.\d+\.\d+)/) || y.match(/micromessenger\/(\d+\.\d+)/);
          return e ? e[1] : '';
        } (),
        A = {
          initStartTime: p(),
